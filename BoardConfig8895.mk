...
include vendor/samsung_slsi/exynos/camera/hal3/exynos8895/Android.mk
...
BOARD_BACK_CAMERA_SENSOR := SENSOR_NAME_S5K2L2
BOARD_FRONT_CAMERA_SENSOR := SENSOR_NAME_S5K3H1
BOARD_SECURE_CAMERA_SENSOR := SENSOR_NAME_S5K5E6

BOARD_CAMERA_USES_DUAL_CAMERA := true
BOARD_BACK_1_CAMERA_SENSOR := SENSOR_NAME_S5K3M3
